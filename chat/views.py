...
openai_api_key = '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'
...
class ChatListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['board'] = Chat.objects.filter(user=self.request.user)
        return context
...
def send_message(request, chat_slug):
    ...
    if request.method == 'POST':
        ...
        if message:
            ...
            # Create a dictionary to be serialized as JSON
            response_data = {
                'response': response,
